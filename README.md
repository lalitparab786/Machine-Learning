...
__I am using Gender Recognition by Voice and Speech Analysis for this Project__


![voice img](https://user-images.githubusercontent.com/89013703/191904756-aab4c309-c530-43a5-bdb6-eeb14e713549.png)
...
We get accuracy with rbf and linear kernel with C=100.0 and the accuracy is 0.9734. So, we can conclude that our model is doing a very good job in terms of predicting the class labels.I also calculate cross_val_score for model and it gives me value of 0.9759.

ROC AUC of our model is very close to 1. So, we can conclude that our classifier does a good job in classifying the Voice.
...
Our original model test accuracy is 0.9700 while GridSearch CV score on test-set with high Accuracy of  __0.9763__. So, GridSearch CV really helps to identify the best parameters that will improve the performance of our Model.
